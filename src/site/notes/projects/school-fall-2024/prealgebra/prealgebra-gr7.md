...
- [x] #hw (math) 5.6 Summary (p. 240) problem 5.35-5.44 [[2025-01-13\|2025-01-13]]
- [x] #hw (math) 5.6 Summary (p. 240) problem 5.45-5.50 [[2025-01-15\|2025-01-15]] [score:: 5/6]
    - Substitution error, didn't include entire equation
- [x] #hw (math) 5.6 Summary (p. 240) problem 5.51-5.53 [[2025-01-17\|2025-01-17]] 
## 6 Decimals (p. 247)

- [x] #hw (math) 6.1 Arithmetic with Decimals (p. 247)  [score:: 15/19]
- [x] #hw (math) 6.2 Rounding (p. 258) [score:: 7/9]
- [x] #hw (math) 6.3 Decimals and Fractions (p. 263) [score:: 13/16]
- [x] #hw (math) 6.4 Repeating Decimals (p. 267) [score:: 13/20]
- [x] #hw (math) 5.6 Summary (p. 240) 
...
- [x] #hw (math) 7.4 Conversions (p. 296) [score:: 13/14]
- [x] #hw (math) 7.5 Speed (p. 302) [score:: 5/11]
- [x] #hw (math) 7.6 Other Rates (p. 310) [score:: 6/10]
- [ ] (math) 6.5 Summary (p. 278)

## 8 Percents (p. 320)

- [x] #hw (math) 8.1 What is a Percent? (p. 320)
- [x] #hw (math) 8.2 Word Problems (p. 331)
- [x] #hw (math) 8.3 Percent Increase and Decrease (p. 337)
- [ ] (math) 7.7 Summary (p. 314)

## 9 Square Roots (p. 351)

- [x] #hw (math) 9.1 From Squares to Square Roots (p. 351)
- [x] #hw (math) 9.2 Square Roots of Non-square Integers (p. 358)
- [x] #hw (math) 9.3 Arithmetic with Square Roots (p. 363)
- [ ] (math) 8.4 Summary (p. 346)

## 10 Angles (p. 378)

- [x] #hw (math) 10.1 Measuring Angles (p. 378)
- [x] #hw (math) 10.2 Parallel Lines (p. 392)
- [x] #hw (math) 10.3 Angles in Polygons (p. 397)
- [ ] (math) 9.4 Summary (p. 373)

## 11 Perimeter and Area (p. 415)

- [x] #hw (math) 11.1 Measuring Segments (p. 415)
- [x] #hw (math) 11.2 Area (p. 422)
- [x] #hw (math) 11.3 Circles (p. 432)
- [ ] (math) 10.4 Summary (p. 409)

## 12 Right Triangles and Quadrilaterals (p. 442)

- [x] #hw (math) 12.1 The Pythagorean Theorem (p. 442)
- [x] #hw (math) 12.2 Some Special Triangles (p. 451)
- [x] #hw (math) 12.3 Types of Quadrilaterals (p. 457)
- [ ] (math) 11.4 Summary (p. 437)

## 13 Data and Statistics (p. 476)

- [x] #hw (math) 13.1 Basic Statistics (p. 476)
- [x] #hw (math) 13.2 Limits of Basic Statistics (p. 486)
- [x] #hw (math) 13.3 Tables, Graphs, and Charts (p. 494)
- [ ] (math) 12.4 Summary (p. 469)

## 14 Counting (p. 509)

- [x] #hw (math) 14.1 Counting with Addition and Subtraction (p. 510)
- [x] #hw (math) 14.2 The Multiplication Principle (p. 519)
- [x] #hw (math) 14.3 Casework (p. 525)
- [x] #hw (math) 14.4 Counting Pairs (p. 530)
- [ ] #hw (math) 14.5 Probability (p. 536)
- [ ] (math) 13.4 Summary (p. 505)

## 15 Problem-Solving Strategies (p. 547)

- [x] #hw (math) 15.1 Find a Pattern (p. 547)
- [ ] #hw (math) 15.2 Make a List (p. 552)
- [ ] #hw (math) 15.3 Draw a Picture (p. 556)
- [ ] #hw (math) 15.4 Work Backwards (p. 560)
- [ ] (math) 14.6 Summary (p. 541)
- [ ] (math) 15.5 Summary (p. 564)